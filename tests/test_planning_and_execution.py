...
def test_add_reference_item(planning_service, mock_repo):
    ...
    # Note: add_reference_item is not explicitly in the interface but add_manual_item handles it
    planning_service.add_manual_item("1", "reference", "Docs", content="http://docs.com")
